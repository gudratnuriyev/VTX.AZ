        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-start">
          ...
          <div className="lg:col-span-8">
             <p className="text-2xl md:text-4xl font-light text-neutral-800 leading-normal mb-12">
               "Marmara Group olaraq illərdir tələbələrin xaricdə təhsil arzularını reallaşdırırıq. Bizimlə dünyanın ən yaxşı universitetlərinə qəbul olmaq daha asandır."
             </p>
