      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        <div className="max-w-4xl">
          <div className="flex items-center space-x-2 mb-6">
            <span className="w-12 h-[1px] bg-vtx-accent"></span>
            <span className="text-vtx-accent font-bold uppercase tracking-widest text-sm">Gələcəyini Qur</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              href="#contact"
              className="group flex items-center justify-between px-8 py-4 bg-vtx-accent text-white rounded-full hover:bg-vtx-primary transition-all duration-300 w-full sm:w-auto"
            >
