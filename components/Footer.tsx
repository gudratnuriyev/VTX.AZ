      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-24">
          ...
          <div className="lg:col-span-2">
            <a href="#" className="text-3xl font-bold tracking-tighter text-neutral-900 block mb-8">
            ...
            <div className="flex space-x-6">
               <a href="#" className="w-10 h-10 rounded-full border border-neutral-300 flex items-center justify-center text-neutral-600 hover:bg-electric-600 hover:text-white hover:border-electric-600 transition-all">
                 <Instagram size={18} />
               </a>
               <a href="#" className="w-10 h-10 rounded-full border border-neutral-300 flex items-center justify-center text-neutral-600 hover:bg-electric-600 hover:text-white hover:border-electric-600 transition-all">
                 <Facebook size={18} />
          ...
          <div>
             ...
             <ul className="space-y-4">
               {NAVIGATION_LINKS.map(link => (
                 <li key={link.name}>
                   <a href={link.href} className="text-neutral-600 hover:text-electric-600 transition-colors">
                     {link.name}
                   </a>
                 </li>
               ))}
          ...
          <div>
             ...
             <ul className="space-y-6">
               <li className="flex items-start">
                  <MapPin className="mr-3 text-electric-600 mt-1" size={18} />
                  <span className="text-neutral-600">{CONTACT_INFO.address}</span>
               </li>
               <li className="flex items-center">
                  <Phone className="mr-3 text-electric-600" size={18} />
                  <a href={`tel:${CONTACT_INFO.phone}`} className="text-neutral-600 hover:text-electric-600">{CONTACT_INFO.phone}</a>
               </li>
               <li className="flex items-center">
                  <Mail className="mr-3 text-electric-600" size={18} />
                  <a href={`mailto:${CONTACT_INFO.email}`} className="text-neutral-600 hover:text-electric-600">{CONTACT_INFO.email}</a>
               </li>
             </ul>
          </div>
